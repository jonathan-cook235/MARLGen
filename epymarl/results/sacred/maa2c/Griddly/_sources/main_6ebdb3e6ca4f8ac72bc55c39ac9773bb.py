...
def my_main(_run, _config, _log):
    ...
    # run the framework
    config = {'runner': 'parallel', 'mac': 'basic_mac', 'env': 'griddlygen', 'env_args': {}, 'batch_size_run': 10,
          ...
          'hypergroup': None, 'action_selector': 'soft_policies', 'epsilon_start': 1.0, 'epsilon_finish': 0.05,
          'epsilon_anneal_time': 5000, 'evaluation_epsilon': 0.0, 'mask_before_softmax': True,
          'target_update_interval_or_tau': 200, 'obs_individual_obs': False, 'agent_output_type': 'pi_logits',
          'learner': 'actor_critic_learner', 'entropy_coef': 0.01, 'standardise_returns': False, 'standardise_rewards': True,
          'use_rnn': False, 'q_nstep': 5, 'critic_type': 'cv_critic', 'epochs': 4, 'eps_clip': 0.2, 'name': 'maa2c',
          'seed': 717628456, 'mixing_embed_dim': 32, 'hypernet_layers': 2, 'hypernet_embed': 64, 'max_before_softmax': True}
