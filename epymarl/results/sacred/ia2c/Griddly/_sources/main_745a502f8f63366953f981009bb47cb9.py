...
def my_main(_run, _config, _log):
    ...
    config = {'runner': 'parallel', 'mac': 'basic_mac', 'env': 'griddlygen', 'env_args': {}, 'batch_size_run': 10,
          ...
          'use_rnn': True, 'q_nstep': 5, 'critic_type': 'ac_critic', 'epochs': 4, 'eps_clip': 0.2, 'name': 'ia2c',
          'seed': 1976, 'mixing_embed_dim': 32, 'hypernet_layers': 2, 'hypernet_embed': 64, 'max_before_softmax': True}
...
if __name__ == '__main__':
    ...
    params = ['src/main.py', '--config=ia2c', '--env-config=griddlygen']
