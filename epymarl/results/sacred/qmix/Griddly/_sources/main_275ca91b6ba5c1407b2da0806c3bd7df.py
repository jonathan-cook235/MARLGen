...
def my_main(_run, _config, _log):
    ...
    # run the framework
    config = {'runner': 'episode', 'mac': 'basic_mac', 'env': 'griddlygen', 'env_args': {'seed': 6518}, 'batch_size_run': 10,
          ...
          'hypergroup': None, 'action_selector': 'epsilon_greedy', 'epsilon_start': 1.0, 'epsilon_finish': 0.05,
          ...
          'seed': 6518, 'mixing_embed_dim': 32, 'hypernet_layers': 2, 'hypernet_embed': 64, 'max_before_softmax': True,
