...
def run(_run, _config, _log, level_seeds):
    # check args sanity
    print('running')
    ...
    run_sequential(args=args, logger=logger, level_seeds=level_seeds)
...
def run_sequential(args, logger, level_seeds=[]):
    # Init runner so we can get env info
    print('setting up runner')
    # print(args)
    # args.level_seeds = level_seeds
    runner = r_REGISTRY[args.runner](args=args, logger=logger, level_seeds=level_seeds)
    print('got runner')
