...
def my_main(_run, _config, _log):
    ...
    # run the framework
    config = {'runner': 'episode', 'mac': 'basic_mac', 'env': 'griddlygen', 'env_args': {}, 'batch_size_run': 10,
          ...
          'target_update_interval_or_tau': 0.01, 'obs_individual_obs': False, 'agent_output_type': 'q',
          ...
          'seed': 717628456, 'mixing_embed_dim': 32, 'hypernet_layers': 2, 'hypernet_embed': 64, 'double_q': True}
