...
def my_main(_run, _config, _log):
    ...
    config = {'runner': 'parallel', 'mac': 'basic_mac', 'env': 'griddlygen', 'env_args': {}, 'batch_size_run': 10,
          ...
          'learner': 'ppo_learner', 'entropy_coef': 0.01, 'standardise_returns': True, 'standardise_rewards': True,
          'use_rnn': False, 'q_nstep': 5, 'critic_type': 'cv_critic', 'epochs': 4, 'eps_clip': 0.2, 'name': 'mappo',
