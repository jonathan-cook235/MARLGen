...
def my_main(_run, _config, _log):
    ...
    # run the framework
    config = {'runner': 'parallel', 'mac': 'basic_mac', 'env': 'vmas',
              ...
              'agent_output_type': 'pi_logits', 'learner': 'ppo_learner', 'entropy_coef': 0.0, 'standardise_returns': False,
...
if __name__ == '__main__':
    ...
    params = ['src/main.py', '--config=ippo', '--env-config=vmas']
