...
def my_main(_run, _config, _log):
    ...
    logging_name = 'IQL-Foraging-100Train-'+str(random_seed)
    ...
    config = {'runner': 'episode', 'mac': 'basic_mac', 'env': 'griddlygen',
              ...
              'eps_clip': 0.2, 'name': "iql", 'seed': random_seed, 'mixing_embed_dim': 32, 'hypernet_layers': 2,
              'hypernet_embed': 64, 'max_before_softmax': True, 'double_q': True, 'mixer': None,
