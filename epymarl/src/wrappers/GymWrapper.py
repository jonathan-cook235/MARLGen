...
class GymWrapper(gym.Env):
    ...
    def step(self, action):
        ...
        state = self._get_observation(self.game.observe(), self._global_observer_type)
    ...
    def return_observations(self, level_id=None, level_string=None, global_observations=False):
