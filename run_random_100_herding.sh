#$ -S /bin/bash
#$ -N Random-100-Herding
#$ -cwd
#$ -o $HOME/result-random-100-herding.out
#$ -e $HOME/result-random-100-herding.err
#$ -l h_rt=12:00:00
#$ -l gpu=true
#$ -l hostname='!bert'
#$ -R y
...
python Dissertation/epymarl/src/main_random_100_herding.py 
